...
<form id="main_form">
<div class="wrapper">
<div class="regtitle"><div class="reg">新用户注册</div></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="515" valign="top">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="registerleft"><span>*</span>用户名：</td>
    <td id="td_user_name">
  ...
  <tr>
    <td></td>
    <td style="padding:5px 0px;"><div id="btn_sub" class="btnreg">立即注册</div></td>
  </tr>
  <tr>
    <td class="registerleft"></td>
    ...
    <td width="85"></td>
    <td width="600" valign="top"><img src="/images/registerleftadv.jpg" width="600" height="400" /></td>
  </tr>
</table>
</div>
</form>
