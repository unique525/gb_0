            ...
            <table class="topic_list" cellpadding="0" cellspacing="0" width="100%">
                <icms id="forum_topic_list_normal" type="list"  where="parent">
                    <item>
                        <![CDATA[
                        <tr>
                            <td class="forum_topic_item" width="50px" style="padding-right:10px;"><img src="/front_template/default/skins/gray/no_avatar_small.gif"/></td>
                            <td class="forum_topic_item" align="left" class="forum_topic_title" style="font-size: 16px;fpm"><a href="/default.php?mod=forum_post&a=list&forum_topic_id={f_ForumTopicId}">{f_ForumTopicTitle}</a></td>
