                    ...
                    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td style="padding:4px 0;">
                                ...
                                <input type="text" value="{ForumTopicTitle}" class="iColorPicker input_box_topic_title" id="f_ForumTopicTitle" name="f_ForumTopicTitle" style="width:70%;" maxlength="300" />
