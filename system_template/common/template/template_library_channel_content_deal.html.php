        ...
        function submitForm(closeTab) {
            ...
            if ($('#f_TemplateName').val() == '') {
                ...
                $("#mainForm").attr("action", "/default.php?secu=manage" +
                    "&mod=template_library_channel_content&m={method}" +
                    "&template_library_channel_content_id={TemplateLibraryChannelContentId}" +
            ...
            <tr>
                ...
                <td class="spe_line">
                    ...
                    <span id="btn_download_attachment" style="cursor:pointer">
                        <a href="/default.php?secu=manage&mod=template_library_channel_content&m=get_attachment&template_library_channel_content_id={TemplateLibraryChannelContentId}" target="_blank">
                            [下载]
                        </a>
                    </span>
