                ...
                <li id="sort_{f_NewspaperArticleId}">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr class="grid_item">
                            ...
                            <td class="spe_line2" style="width:40px;text-align:center;"><img class="btn_modify" title="文章编辑" style="cursor:pointer;" src="/system_template/{template_name}/images/manage/edit.gif" idvalue="{f_NewspaperArticleId}" alt="编辑"/></td>
