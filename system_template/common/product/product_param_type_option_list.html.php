...
<div class="div_list">
    ...
    <table class="grid" width="100%" cellpadding="0" cellspacing="0">
        <tr class="grid_title">
            ...
            <td style="width:100px; text-align:center;">编辑参数选项</td>
            <td style="width:100px; text-align:center;">参数类型</td>
        ...
        <icms id="product_param_type_option_list" type="list">
            <item>
                ...
                <tr class="grid_item">
                    ...
                    <td class="spe_line2" style="text-align: center;"><span class="btn_open_product_param_type_option_option_list" style="cursor:pointer;" idvalue="{f_ProductParamTypeId}" idname="{f_ParamTypeName}" title="{f_ParamValueType}" lang="" ></span></td>
