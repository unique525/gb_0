...
<td class="spe_line2" style="text-align: center;"><span class="btn_open_product_param_type_class_list" style="cursor:pointer;"  idvalue="{f_ProductParamTypeClassId}" title="{f_ProductParamTypeClassName}" >编辑题目</span></td>
