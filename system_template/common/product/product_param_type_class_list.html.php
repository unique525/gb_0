...
<head>
    ...
    {common_head}
    <script type="text/javascript" src="/system_js/manage/product_param_type_class/product_param_type_class.js"></script>
</head>
<body>
...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td id="td_main_btn">
            <input id="btn_create" class="btn2" value="新建产品参数类型类别" title="在本频道新建产品参数类型类别" type="button"/>
        </td>
    </tr>
</table>
...
<td style="text-align: center">产品参数类型类别名</td>
<td style="text-align: center">产品参数类型类别ID</td>
<td style="width:60px; text-align:center;">编辑产品参数类型</td>
...
<td class="spe_line2" style="text-align: center;">{f_ProductParamTypeClassTitle}</td>
<td class="spe_line2" style="text-align: center;">{f_ProductParamTypeClassId}</td>
<td class="spe_line2" style="text-align: center;"><span class="btn_open_product_param_type_class_list" style="cursor:pointer;"  idvalue="{f_ProductParamTypeClassId}" title="{f_ProductParamTypeClassTitle}" >编辑题目</span></td>
