    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            btnConfirm.click(function(){
                ...
                if (forumPostTitle.val() == '') {
                    $("#dialog_box").dialog({width: 300, height: 100});
                    $("#dialog_content").html("请输入标题");
                } else {
                    $("#mainForm").attr("action",
                        "/default.php?secu=manage&mod=forum_post&a=modify&forum_post_id="+forumPostId+"&site_id="+siteid+"&forum_topic_id="+forumTopicId);
                    $('#mainForm').submit();
                }
            });
        });
        ...
        <table width="60%" align="center" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td style="height:36px;text-align:center;">
                    标题：<input type="text" class="input_box_topic_title" id="f_ForumPostTitle" name="f_ForumPostTitle"
                              value="{f_ForumPostTitle}" style="width:70%;" maxlength="300"  />
                    <input type="hidden" id="f_ForumPostId" name="f_ForumPostId" value="{f_ForumPostId}"/>
                </td>
            </tr>
            <tr>
