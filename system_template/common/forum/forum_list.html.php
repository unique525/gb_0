                        ...
                        <tr class="grid_item">
                            ...
                            <td class="spe_line2" style="width:40px;text-align:left;">
                                <img class="img_modify_state system_image" style="cursor: pointer"
                                     ...
                                     idvalue="{f_ForumId}" title="改变版块状态" alt="改变状态"/>

                                <div class="forum_state_box" id="div_state_{f_ForumId}" idvalue="{f_ForumId}" title="">
                                    <div style="float:right;"><img class="span_close_box system_image"
                                                                   idvalue="{f_ForumId}" title="关闭"
                            ...
                            <td class="spe_line2" style="width:36px;">
                                <img class="img_up system_image" style="cursor: pointer"
                                     ...
                                     idvalue="{f_ForumId}" title="向上移动" alt="向上"/><img class="img_down system_image"
