<li id="forumsort_{f_forumid}">
    <table class="docgrid" cellpadding="0" cellspacing="0">
        <tr class="griditem">
            ...
            <td class="speline2" style="width:90px;text-align:center;"><span class="formatstate">{f_state}</span></td>
            <td class="speline2" style="width:40px;text-align:left;">
                ...
                <div class="forumstatebox" id="divstate_{f_forumid}" idvalue="{f_forumid}" title="">
                    ...
                    <div style="clear:both;">
                        ...
                        <div class="forumstate" statevalue="3" idvalue="{f_forumid}">按用户加密</div>
                        <div class="forumstate" statevalue="4" idvalue="{f_forumid}">按身份加密</div>
                        <div class="forumstate" statevalue="5" idvalue="{f_forumid}">按发帖加密</div>
                        <div class="forumstate" statevalue="6" idvalue="{f_forumid}">按积分加密</div>
                        <div class="forumstate" statevalue="7" idvalue="{f_forumid}">按金钱加密</div>
                        <div class="forumstate" statevalue="8" idvalue="{f_forumid}">按魅力加密</div>
                        <div class="forumstate" statevalue="9" idvalue="{f_forumid}">按经验加密</div>
                        <div class="forumstate" statevalue="10" idvalue="{f_forumid}">禁止发帖</div>
                        <div class="forumstate" statevalue="100" idvalue="{f_forumid}">已删除</div>
                        <div class="spe"></div>
                    </div>
                </div>
            </td>
