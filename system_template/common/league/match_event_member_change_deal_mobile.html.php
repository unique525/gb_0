...
<head>
    ...
    <script>
        $(function(){
            ...
            if(parseInt($("#f_OffMemberId").val())>0){
                var oriTeamId=$("#f_TeamId").val();
                var oriName=$(".member_option[idvalue='{OffMemberId}']").html();
                var oriAssistorName=$(".assistor_option[idvalue='{AlternateMemberId}']").html();
        ...
        function submitForm(continueCreate) {
            ...
            if ($('#f_OffMemberId').val() == '') {
                error+="请选择登场队员！\r\n";
                submit=0;
            }
            if ($('#f_AlternateMemberId').val() == '') {
                error+="请选择离场队员！\r\n";
                submit=0;
            }
        ...
        <form data-ajax="false" id="main_form" action="/default.php?secu=manage&mod=member_change&m={method}&match_id={MatchId}&member_change_id={MemberChangeId}" method="post">
            ...
            <div class="detail_container">
                ...
                <div class="nav_content events_container">
                    ...
                    <input name="f_OffMemberId" id="f_OffMemberId" value="{OffMemberId}" type="hidden"/>
                    <a href="#leftpanel_member_home" id="member_of_{HomeTeamId}" class="member_list_btn ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow">选择离场队员</a>
                    ...
                    <a href="#leftpanel_member_guest" id="member_of_{GuestTeamId}" class="member_list_btn ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow">选择离场队员</a>
                    <div data-role="panel" id="leftpanel_member_guest" data-position="left" data-display="overlay" data-theme="a" class="ui-panel ui-panel-position-left ui-panel-display-overlay ui-body-a ui-panel-animate ui-panel-open">
                        <ul data-role="listview" data-inset="true" >
                            ...
                            <li data-rel="close"><a idvalue="525" team_id="{GuestTeamId}" class="member_option">{f_MemberName}({f_Number}号)</a></li>
                        </ul>
                    </div>


                    <input name="f_AlternateMemberId" id="f_AlternateMemberId" value="{AlternateMemberId}" type="hidden"/>
                    <a href="#leftpanel_assistor_home" id="assistor_of_{HomeTeamId}" class="member_list_btn ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow">选择登场队员</a>
                    <div data-role="panel" id="leftpanel_assistor_home" data-position="left" data-display="overlay" data-theme="a" class="ui-panel ui-panel-position-left ui-panel-display-overlay ui-body-a ui-panel-animate ui-panel-open">
                        <ul data-role="listview" data-inset="true" >
                            ...
                            <li data-rel="close"><a idvalue="525" team_id="{HomeTeamId}" class="member_option">{f_MemberName}({f_Number}号)</a></li>
                        </ul>
                    </div>

                    <a href="#leftpanel_assistor_guest" id="assistor_of_{GuestTeamId}" class="member_list_btn ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow">选择登场队员</a>
