...
<body>
{common_body_deal}
<form id="main_form" action="/default.php?secu=manage&mod=member&m={method}&member_id={MemberId}&site_id={SiteId}&tab_index={TabIndex}" method="post">
    ...
    <div style="margin: 0 auto 10px;">
        <table width="99%" class="doc_grid" cellpadding="0" cellspacing="0">
            <tr class="grid_item">
                <td class="spe_line" style="height:30px;text-align:right"><label for="f_MemberName">名字：</label></td>
                <td class="spe_line"><input type="text" id="f_MemberName" name="f_MemberName" value="{MemberName}"/></td>
            </tr>
            <tr class="grid_item">
                <td class="spe_line" style="height:30px;text-align:right"><label for="f_BirthDay">生日：</label></td>
                <td class="spe_line"><input type="text" class="GetDate" id="f_BirthDay" name="f_BirthDay" value="{BirthDay}"/></td>
            </tr>
            <tr class="grid_item">
                <td class="spe_line" style="height:30px;text-align:right"><label for="f_TeamId">所在队：</label></td>
                <td class="spe_line">
                    <input type="number" class="" id="f_TeamId" name="f_TeamId" value="{TeamId}"/>
                    <input type="text" class="" id="TeamName"  value="{TeamName}"/>
