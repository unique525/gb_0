    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#sel_site").change(function() {
                ...
                if(siteId>0){
                    window.location.href="/default.php?secu=manage&mod=manage_user_authority&m=set_by_manage_user&manage_user_id={ManageUserId}&manage_user_name={ManageUserName}&site_id="+siteId;
                }
                $("#selectall").html("全选");
            });
        });
        ...
        **/
        function GetChildren(parentId,rank){
            ...
            if(parentId>0){
                $.ajax({
                    url: "/default.php?secu=manage&mod=manage_user_authority&m=get_child_channel_list&type=manage_user",
                    data: {ParentId: parentId,ManageUserId: {ManageUserId}},
                    type: "POST",
                    dataType: 'json',
        ...
        function submitForm(closeTab) {
            ...
            var siteId= parseInt($("#sel_site").val());
            $("#mainForm").attr("action", "/default.php?secu=manage&mod=manage_user_authority&m=set_by_manage_user&manage_user_id={ManageUserId}&site_id="+siteId+"&tab_index=" + parent.G_TabIndex + "");
            $('#mainForm').submit();
