            ...
            <div style="margin:0 auto;margin-left: 10px;">
                <table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="spe_line"><input name="f_IpMaxCount" id="f_IpMaxCount" value="{IpMaxCount}" type="text" class="inputnumber" style=" width: 60px;" />(注:输入数字,设定每天同一IP最多投票数)</td>
                    </tr>
                    <tr>
                        <td class="spe_line" height="30" align="right">用户数限制：</td>
                        <td class="spe_line"><input name="f_UserMaxCount" id="f_UserMaxCount" value="{UserMaxCount}" type="text" class="inputnumber" style=" width: 60px;" />(注:输入数字,设定每天同一用户最多投票数，0表示不限制)</td>
                    </tr>
                    <tr>
                        <td class="spe_line" height="30" align="right">用户每票积分数：</td>
                        <td class="spe_line"><input name="f_UserScoreNum" id="f_UserScoreNum" value="{UserScoreNum}" type="text" class="inputnumber" style=" width: 60px;" />(注:输入数字,设定用户每投一票获得积分数，0表示不积分)</td>
                    </tr>
                    <tr>
