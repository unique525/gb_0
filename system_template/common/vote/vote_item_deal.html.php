            ...
            <div style="margin: 0 auto;margin-left: 10px;">                
                <table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="spe_line"><input name="f_SelectNumMin" id="f_SelectNumMin" value="{SelectNumMin}" type="text" class="inputnumber" style=" width: 60px;" />(注:为0表示不限制)</td>
                    </tr>
                    <tr>
                        <td class="spe_line" height="30" align="right">最大选择数：</td>
                        <td class="spe_line"><input name="f_SelectNumMax" id="f_SelectNumMax" value="{SelectNumMax}" type="text" class="inputnumber" style=" width: 60px;" />(注:为0表示不限制)</td>
                    </tr>
                    <tr>
