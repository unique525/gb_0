		...
		<ul>
			...
			<li>
				...
				<select name="s" size="1">
					<option value="s_create_date_DESC" selected="selected" <?php echo $s_s_create_date_DESC; ?>>按时间降序</option>                                    
					<option value="relevance">相关性</option>
					<option value="s_create_date" <?php echo $s_s_create_date_ASC; ?>>按时间升序</option>
				</select>
				排序
			</li>
		</ul>
...
2=>array("http://mcswb.changsha.cn","长沙晚报"),
...
26=>array("http://travel.changsha.cn","旅游频道"),
27=>array("http://baby.changsha.cn","母婴频道"),
28=>array("http://www.cslxsh.gov.cn/","两型城市网"),
29=>array("http://ht.changsha.cn","星辰话题"),
29=>array("http://lsq.changsha.cn","刘少奇纪念馆"),
31=>array("http://www.csonline.com.cn","中国百城"),
32=>array("http://wz.changsha.cn","网络问政"),
39=>array("http://315.changsha.cn","消费维权")
); 
...
<?php
$NewsTitle = "";
$NewsTitle = $search->highlight(htmlspecialchars($doc->s_title));
if ($domain[$doc->s_site_id][0]==null){
	echo $NewsTitle;
}else{
