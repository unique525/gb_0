...
function _ChannelClick() {
    if (window.G_SelectedChannelId > 0) {
        ...
        if (window.G_SelectedChannelType === 1) { //新闻类频道
            ...
            window.G_TabTitle = "";
            window.G_TabUrl = '/default.php?secu=manage&mod=activity&m=list&site_id='+ window.G_NowSiteId +'&site_name='+ parent.G_SelectedChannelName +'&channel_id=' + window.G_SelectedChannelId;
            addTab();
            ...
            window.G_TabTitle = "";
            window.G_TabUrl = '/default.php?secu=manage&mod=custom_form&m=list&site_id='+ window.G_NowSiteId +'&site_name='+ parent.G_SelectedChannelName +'&channel_id=' + window.G_SelectedChannelId;
            addTab();
